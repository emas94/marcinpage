...
const HomeOffers = () => {
  ...
  return (
    <div className={styles.wrapper} id="oferta">
      <HeaderTitle
        elementRef={elementRef}
        delay={300}
        title="Płoty"
        subTitle="Mamy bardzo fajne płoty"
      />
      <DisplayContainer
        elementRef={fenceArrayRef}
        timeDelay={1}
        spaceBefore={400}
      >
      ...
      <HeaderTitle
        ...
        delay={300}
        title="Na pewno nie Płoty"
        subTitle="Mamy bardzo fajne Na pewno nie Płoty"
      />
      <DisplayContainer
        elementRef={noFenceArrayRef}
        timeDelay={1}
        spaceBefore={400}
      >
        <div className={styles.offersWrapper}>
      ...
      <HeaderTitle
        elementRef={thirdElementRef}
        delay={300}
        title="Wszystko inne"
        subTitle="Mamy bardzo fajne Wszystko inne"
      />
      <DisplayContainer
        elementRef={othersArrayRef}
        timeDelay={1}
        spaceBefore={400}
      >
        <div className={styles.offersWrapper}>
